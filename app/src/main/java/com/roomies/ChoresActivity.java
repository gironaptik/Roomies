...
public class ChoresActivity extends AppCompatActivity {
    ...
    private void customeDialog(){
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String mType = by.getText().toString().trim();
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Data, ShoppinglistActivity.MyViewHolder> adapter = new FirebaseRecyclerAdapter<Data, ShoppinglistActivity.MyViewHolder>(
                Data.class,
                R.layout.item_data,
                ShoppinglistActivity.MyViewHolder.class,
                mApartmentDatabase
        ) {


            @Override
            protected void populateViewHolder(ShoppinglistActivity.MyViewHolder myViewHolder, Data model, int i) {
...
//                String mdAmmount=String.valueOf(amount);
                ...
                Data data=new Data(by,intammount,note,date,postKey);
